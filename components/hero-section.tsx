...
export function HeroSection() {
  ...
  const images = [
    "https://t3.ftcdn.net/jpg/02/28/28/16/360_F_228281605_zX4rGhhAX6fNkBgx7dp1IXu8XMnhCl01.jpg?height=600&width=800",
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXoXS6W5ji4oyHHj22cnlnm1GXEeMIBG4YfQ&s?height=600&width=800",
    "https://media.istockphoto.com/id/1292563627/photo/assorted-south-indian-breakfast-foods-on-wooden-background-ghee-dosa-uttappam-medhu-vada.jpg?s=612x612&w=0&k=20&c=HvuYT3RiWj5YsvP2_pJrSWIcZUXhnTKqjKhdN3j_SgY=?height=600&width=800",
  ]
